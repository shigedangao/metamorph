...
use futures::Stream;
use granc_core::client::{DynamicRequest, DynamicResponse, GrancClient, Online};
use reqwest::StatusCode;
use reqwest_streams::error::StreamBodyError;
use serde_json::{Value, json};
use std::{pin::Pin, str::FromStr, sync::Arc, time::Instant};
...
impl GrpcClient {
    ...
    pub async fn new(base_url: &str, headers: Vec<(String, String)>) -> Result<Arc<Self>> {
        ...
        Ok(Arc::new(Self { client, headers }))
    }
